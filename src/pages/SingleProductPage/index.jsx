...
export default function SingleProductPage() {
    ...
    if (!product) {
        return <p>Sorry, the product was not found.</p>;
    }
                    ...
                    <div className={style.priceGrid}>
                        {
                            discount
                                ? (
                                    <>
                                        <p className={style.noWrapPrice}><span className={style.discont_price}>{discont_price}</span> <span className={style.boldDollar}>$</span></p>
